...
<head>
 ...
 <title>Patient History - Clinic's Patient Management System </title>
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-lg-1 col-md-2 col-sm-4 col-xs-12">
               <a type="button" id="search" 
              class="btn btn-primary btn-sm btn-flat btn-block" onclick="history_loc();">Save as PDF</a>
            </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 table-responsive">
                <table id="patient_vacination" class="table table-striped table-bordered">
                  ...
                  <thead>
                    <tr class="bg-gradient-primary text-light">
                      <th class="p-1 text-center">Consultation of Prenatal</th>
                      <th class="p-1 text-center">Date of Vacination</th>
                      <th class="p-1 text-center">Date of Next Vacination</th>
                      <th class="p-1 text-center">Age</th>
                    </tr>
...
//event driven programming
  ...
  function history_loc(){
    var patient=document.getElementById('patient').value;
    location.href="view_pdf.php?id="+patient;
  }
</script>
