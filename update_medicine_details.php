...
if(isset($_POST['submit'])) {
  ...
  `packing` = '$packing',
  `Number_of_supply` = '$Numberofsupply',
...
// $Numberofsupply = $_GET['Number_of_supply'];
...
<head>
 ...
 <title>Update Medicine Details - Clinic's Patient Management System </title>
          ...
          <div class="card-body">
            <form method="post">
              ...
              <div class="row">
                ...
                <input  id="Number_of_supply" name="Number_of_supply" required="required"  
