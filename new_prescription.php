...
//now to store data in medication history
    ...
    for($i = 0; $i < $size; $i++) {
      ...
      $qeuryMedicationHistory="UPDATE medicine_details SET Number_of_supply=Number_of_supply-'$curQuantity', release_medicine=release_medicine+'$curQuantity' WHERE medicine_id='$curMedicineDetailId'";
      $stmtDetails = $con->prepare($qeuryMedicationHistory);
      $stmtDetails->execute();
    }
    ...
    $p_number=getPatients_number($con,$patientId);
    $message = 'Patient Medication stored successfully.';
    $sender="SEMAPHORE";
    $msg='Good day maam/sir your next visit is '.$nextVisitDate;
            ...
            <form method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group date" id="visit_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm rounded-0 datetimepicker-input"
                        data-target="#visit_date" name="visit_date" required="required" data-toggle="datetimepicker"
                        autocomplete="off" />
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-10">
                  <div class="form-group">
                    ...
                    <div class="input-group date" id="next_visit_date" data-target-input="nearest">
                      <input type="text" class="form-control form-control-sm rounded-0 datetimepicker-input"
                        data-target="#next_visit_date" name="next_visit_date" data-toggle="datetimepicker"
                        autocomplete="off" />
              ...
              <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                  ...
                  <input id="Ffrequency" class="form-control form-control-sm rounded-0" />
                </div>
