...
<aside class="main-sidebar sidebar-dark-primary bg-black elevation-4">
    <a href="./" class="brand-link logo-switch bg-black">
      ...
      <h4 class="brand-image-xl logo-xl mb-0 text-center">MHO <b>Cabanglasan</b></h4>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" id="mnu_Certificate">
            <a href="certificate.php" class="nav-link" target="_blank">
