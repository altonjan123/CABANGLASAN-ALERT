...
if (isset($_POST['save_Patient'])) {
    ...
    $gender = $_POST['gender'];
if ($patientName != '' &&  $Purok !='' && $address != '' && 
  $cnic != '' && $dateBirth != '' && $phoneNumber != '' && $gender != '') {
      $query = "INSERT INTO `patients`(`patient_name`, `Purok`, 
    `address`, `cnic`, `date_of_birth`, `phone_number`, `gender`)
VALUES('$patientName','$Purok', '$address', '$cnic', '$dateBirth',
'$phoneNumber', '$gender');";
try {
...
$query = "SELECT `id`, `patient_name`,`Purok`,`address`, 
...
<head>
 ...
 <?php include './config/data_tables_css.php';?>
  ...
  <title>Patients - Clinic's Patient Management System </title>
        ...
        <div class="card-body">
          <form method="post">
            <div class="row">
              ...
              <label>*<br>Patient Name<br>
             (Last Name, First Name, Middle Name)</label>
              <input type="text"   id="patient_name" name="patient_name"   style="text-transform:uppercase" size="20" maxlength="20" required="required "
              ...
              <br>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                <label>*<br>Purok<br>(Sitio)</label> 
                <input type="text" id="Purok" name="Purok"  style="text-transform:uppercase" required="required"
                class="form-control form-control-sm rounded-0"/>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                <label>*<br>Address<br>(Barangay)</label> 
                <input type="text" id="address" name="address" style="text-transform:uppercase"   required="required"
                class="form-control form-control-sm rounded-0"/>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                <label>*<br>Profile Number</label><br>
